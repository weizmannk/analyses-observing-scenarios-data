...
ax.set_xlabel(r' mass $m_1$', fontsize =15, fontname="Times New Roman")
ax.set_ylabel(r'mass $m_2$', fontsize =15, ha='right',  fontname="Times New Roman")
...
ax.text(0.25 * min_mass + 0.75 * ns_max_mass, 0.2 * min_mass + 0.5 * ns_max_mass,
        'BNS', ha='center', va='center', fontsize=18, fontname="Times New Roman",fontweight="bold", 
...
ax.text(0.5 * (bh_min_mass + max_mass), 0.75 * bh_min_mass + 0.25 * max_mass,
        'BBH', ha='center', va='center', fontsize=18, fontname="Times New Roman",fontweight="bold")
...
p = ax.add_patch(Rectangle((bh_min_mass, min_mass),
                           ...
                           color=nsbh_color, linewidth=0))
ax.text(*get_center(p.get_bbox()), 'NSBH', ha='center', va='center',  fontsize=18, fontname="Times New Roman",fontweight="bold")
